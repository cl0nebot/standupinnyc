...
function VenueList ({
  data: {loading, error, allVenues: {aggregate, edges, pageInfo}},
  loadVenues
}) {
...
query allVenues($first: Int!, $skip: Int!) {
  allVenues: venuesConnection(orderBy: createdAt_DESC, first: $first, skip: $skip) {
    edges {
      node {
        id
        name
        ...
        return data.fetchMore({
          ...
          updateQuery: (previousResult, { fetchMoreResult }) => {
            ...
            return Object.assign({}, previousResult, {
              ...
              allVenues: {edges:
                [...previousResult.allVenues.edges, ...fetchMoreResult.allVenues.edges]
              }
            })
          }
        })
